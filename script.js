document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (value && name.toLowerCase().includes('name') && value.length < 2) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f58ab8cb-1eff-490c-bcad-88dd5589db60',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f58ab8cb-1eff-490c-bcad-88dd5589db60';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f58ab8cb-1eff-490c-bcad-88dd5589db60';
